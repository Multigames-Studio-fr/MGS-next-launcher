...
async function populateServerListings(){
    ...
    for(const serv of servers){
        htmlString += `<button class="serverListing flex items-center p-4 bg-gray-800 rounded-lg shadow-lg hover:bg-gray-700 transition duration-300" servid="${serv.rawServer.id}" ${serv.rawServer.id === giaSel ? 'selected' : ''}>
            ...
            <div class="serverListingDetails flex flex-col">
                ...
                <span class="serverListingDescription text-sm text-gray-400">${serv.rawServer.description}</span>
                <div class="serverListingInfo flex items-center mt-2 space-x-4">
                    <div class="serverListingVersion text-sm text-gray-300">${serv.rawServer.minecraftVersion}</div>
                    <div class="serverListingRevision text-sm text-gray-300">${serv.rawServer.version}</div>
